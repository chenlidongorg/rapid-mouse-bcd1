...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-mouse-bcd1
```

A live public deployment of this template is available at [https://rapid-mouse-bcd1.templates.workers.dev](https://rapid-mouse-bcd1.templates.workers.dev)
